...
/// </summary>
[ExecuteAlways]
public class TryStableDiffusionImages2Material : StableDiffusionGenerator
{
    [ReadOnly]
    public string guid = "";
    ...
    IEnumerator GenerateAsync()
    {
        ...
        try
        {
            ...
            //tweak - change the text2img api to img2img api
            ...
            //tweak - change the process to send prompt
        ...
        if (httpWebRequest != null)
        {
            ...
            using (var streamReader = new StreamReader(httpResponse.GetResponseStream()))
            {
                ...
                //tweak - change the SDresponse text2img to img2img
