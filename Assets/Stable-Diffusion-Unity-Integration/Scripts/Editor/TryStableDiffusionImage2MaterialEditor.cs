...
/// </summary>
[CustomEditor(typeof(TryStableDiffusionImages2Material))]
public class TryStableDiffusionImage2MaterialEditor : Editor
{
    public override void OnInspectorGUI()
    {
        base.OnInspectorGUI();

        TryStableDiffusionImages2Material myComponent = (TryStableDiffusionImages2Material)target;
