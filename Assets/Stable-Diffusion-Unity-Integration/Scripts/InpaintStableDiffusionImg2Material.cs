...
/// </summary>
[ExecuteAlways]
public class InpaintStableDiffusionImg2Material : StableDiffusionGenerator
{
    [ReadOnly]
    public string guid = "";
    //add mask texture
    ...
    IEnumerator GenerateAsync()
    {
        ...
        //masktexture processing to texture2d
        Texture2D maskTexture2D = (Texture2D)maskTexture;
        try
        {
            ...
            using (var streamWriter = new StreamWriter(httpWebRequest.GetRequestStream()))
            {
                ...
                string inputImgString = Convert.ToBase64String(inputImgBytes);
                 //masktexture processing to string
                 byte[] maskImgBytes = maskTexture2D.EncodeToPNG();
                ...
                //inpaint
                sd.include_init_images = include_init_images;
